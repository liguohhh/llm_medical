<script setup>
import { ref } from 'vue'
import CategoryList from '@/components/doctor/CategoryList.vue'
import EntryList from '@/components/doctor/EntryList.vue'
import CategoryEditDialog from '@/components/doctor/CategoryEditDialog.vue'
import EntryEditDialog from '@/components/doctor/EntryEditDialog.vue'
